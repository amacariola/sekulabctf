...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { description: @badge.description, user_id: @badge.user_id } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { description: @badge.description, user_id: @badge.user_id } }
